...
function Navbar() {
  ...
  return (
    <nav className="shadow-md sm:p-4 p-3 items-center bg-[#3c64b1]/5">
      <div className="flex flex:row sm:justify-center">
        ...
        <ul className="hidden sm:flex lg:px-40 md:px-7 sm:space-x-4 pl-20 items-center md:space-x-6 lg:space-x-10 sm:text-sm">
          <li>
            <Link
              to="/home"
              className={`font-mulish text-semibold text-[14px] tracking-[0.2px] ${
          ...
          <li>
            <Link
              to="/contact"
              className={`bg-[#6d87cb] font-mulish text-bold text-[14px] tracking-[0.2px] text-white md:px-5 md:py-2 sm:px-3 sm:py-1 hover:bg-blue-700`}
            >
              Contact
            </Link>
          </li>
