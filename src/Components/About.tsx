        ...
        <div className='pt-20 w-[100%]'>
            ...
            <section className='w-full'>
                <div className='md:w-[80%] w-[90%] mx-auto'>
                    <div className=' lg:w-[58%] w-[90%] mx-auto space-y-6 '>
                ...
                <article className='w-full mx-auto '>
                    <div className='flex lg:flex-row  flex-col w-[80%] gap-x-10 mx-auto'>
                        <div className='lg:w-[50%] mx-auto xl:mt-8  space-y-7'>
                            <p className='font-kanit text-[32px] text-[#373f41] text-center  lg:left text'>Our Mission</p>
            ...
            <section className=' '>
                <article className='w-full mx-auto '>
                    <div className='flex lg:flex-row flex-col-reverse w-[80%] mx-auto lg:gap-x-20'>
            ...
            <section className='pt-40 pb-30'>
                <div className='bg-[#eaf0ff] w-[80%] mx-auto rounded-xl'>
                    <div className='flex flex-col xl:w-[64%] lg:w-[75%] pt-10 lg:pb-50  pb-30 mx-auto justify-center '>
                        ...
                        <div className=' pt-5 '>
                            <p className='font-mulish text-center lg:text-[20px] xl:text-[22px] sm:text-[16px] text-[#737b7d]  '>The mesmerizing view of the sun-kissed hills, rich flora-fauna and the cool breeze carrying away the scent of the rosy rhododendrons makes Sitlakhet an ideal retreat.</p>
                            <p className='font-mulish text-center lg:text-[20px] xl:text-[22px] sm:text-[16px]  text-[#737b7d] lg:my-6 md:my-4 my-3 '>A very wide range of Himalayas is visible from here. Surrounded by about 1800 hectares of forest area from all sides.</p>
                            <p className='font-mulish text-center lg:text-[20px] xl:text-[22px] sm:text-[16px]  text-[#737b7d] '>Shitlakhet is known for its natural beauty. Nestled in the lap of nature, this hill station attracts tourists. Shitlakhet is a small hill station. But it is very calm and pleasant. Here you can see the beautiful peaks of the Himalayas.</p>
