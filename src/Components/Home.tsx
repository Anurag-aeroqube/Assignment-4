  ...
  return (
    <div className='py-1'>
      ...
      <section id="about" className="lg:p-10  text-center">
        <div className="max-w-7xl mx-auto flex flex-col lg:pl-20 md:flex-row items-start sm:w-full  mt-20 md:pl-8">
          <img src={about} className="w-full sm:w-[80%] md:w-1/2 mx-auto   lg:pl-16 lg:pr-12 object-fill md:pl-3 rounded-lg " alt="About Villa" />
          <div className="md:w-2/3  md:pb-10 w-fit mx-auto   lg:pr-24 sm:text-left sm:w-[80%] md:px-4 px-2 pt-4 sm:py-5 ">
      ...
      <section className='lg:py-12'>
        <div className='bg-[#3c64b1]/5 items-center w-full lg:px-35 h-full'>
          <div className='sm:flex flex-col justify-center py-6 lg:p-8' >
            ...
            <p className='md:text-[20px] sm:text-base text-[#737b7d]  lg:px-44 md:px-20 mt-5  px-2  text-center'>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
          </div>
          <div className=' mt-4 pb-6'>
            <img src={section3} className=' md:w-[74%] w-full mx-auto '></img>
          </div>
      ...
      <section className='py-10' >
        <div className="flex flex-col md:flex md:flex-row justify-between md:px-20 py-10 items-center md:h-[404px]   ">
          ...
          <div className=" md:w-1/2 md:px-12 px-2 md:mt-3 py-10">
            <img src={cook} alt="On Call Cook" className=" md:w-fit  w-[65%] mx-auto" />
          </div>
        </div>
      ...
      <section className='py-10 ' >
        <div className="flex flex-col md:flex md:flex-row justify-between lg:px-20 lg:py-10 items-center lg:h-[399px] px-3   ">
          <div className=" md:w-1/2 lg:pl-36 md:px-12 ">
            <img src={laundary} alt="On Call Cook" className=" md:w-fit w-[65%] mx-auto" />
          </div>
      ...
      <section className='py-10' >
        <div className="flex flex-col md:flex-row justify-between lg:px-20 py-10 items-center lg:h-[404px] px-3  ">
          ...
          <div className=" md:w-1/2 mt-5 sm:px-20 md:px-14">
            <img src={cleaning} alt="On Call Cook" className=" md:w-fit w-[80%] mx-auto" />
          </div>
        </div>
      ...
      <section className='py-10 ' >
        <div className="flex flex-col md:flex-row justify-between md:px-20 lg:py-10 items-center lg:h-[316px]   ">
          <div className=" md:w-1/2 md:pl-14 md:pr-12 lg:pl-25 lg:pr-20 ">
            <img src={maintenance} alt="On Call Cook" className="md:w-fit w-[80%] mx-auto " />
          </div>
      ...
      <div className='bg-[#3c64b1]/10  w-full   '>
        <div className='md:flex md:flex-row md:justify-between  flex flex-col justify-center md:pt-0 pt-5 md:p-10  lg:p-20'>
          <div className='sm:flex-row md:w-1/2   lg:mt-10 lg:px-15 px-2  '>
            ...
            <div className=' mb-8 sm:w-[30%]  md:w-full sm:mx-auto '>
          ...
          <div className='lg:pr-20 items-center  sm:pl-36   md:pl-0'>
            <img src={section5} className='md:w-full sm:w-[60%] md:tems-start'></img>
          </div>
      ...
      <section className='bg-[#3c64b1]/10 items-center '>
        <div className='py-5 flex flex-col justify-center'>
          ...
          <p className='lg:px-96 px-3 py-5 md:text-[20px] text-[16px] text-center font-mulish leading-[25px] md:eading-[32px] md:px-40  text-[#737b7d]'>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
